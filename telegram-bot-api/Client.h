...
class Client final : public WebhookActor::Callback {
 ...
 private:
  ...
  class JsonChatStatisticsAdministratorActionsInfo;
  class JsonChatStatisticsMessageSenderInfo;
  class JsonChatStatisticsInteractionInfo;
  class JsonStatisticalValue;
  class JsonDateRange;
  ...
  td::Status process_get_similar_chats_query(PromisedQueryPtr &query);
  ...
  void on_update_message_interaction_info(int64 chat_id, int64 message_id,
                                         object_ptr<td_api::messageInteractionInfo> &&interaction_info);
